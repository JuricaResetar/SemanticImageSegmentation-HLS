...
(* CORE_GENERATION_INFO="tansig,hls_ip_2014_1,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=1,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.621000,HLS_SYN_LAT=68,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=0,HLS_SYN_LUT=0}" *)
...
reg   [31:0] tmp_reg_78;
wire   [63:0] grp_fu_48_p1;
reg   [63:0] tmp_1_reg_83;
wire   [63:0] grp_fu_62_p2;
reg   [63:0] tmp_2_reg_88;
wire   [63:0] grp_fu_57_p2;
reg   [63:0] tmp_4_reg_93;
wire   [31:0] grp_fu_44_p1;
wire   [31:0] grp_fu_38_p0;
wire   [31:0] grp_fu_38_p1;
wire   [63:0] grp_fu_44_p0;
wire   [31:0] grp_fu_48_p0;
reg   [63:0] grp_fu_51_p0;
reg   [63:0] grp_fu_51_p1;
wire   [63:0] grp_fu_57_p0;
wire   [63:0] grp_fu_57_p1;
wire   [63:0] grp_fu_62_p1;
wire    grp_fu_38_ce;
wire    grp_fu_44_ce;
wire    grp_fu_48_ce;
wire    grp_fu_51_ce;
wire    grp_fu_57_ce;
wire   [63:0] grp_fu_62_p0;
wire    grp_fu_62_ce;
reg   [6:0] ap_NS_fsm;


tansig_fmul_32ns_32ns_32_4_max_dsp #(
    .ID( 0 ),
    .NUM_STAGE( 4 ),
    .din0_WIDTH( 32 ),
    .din1_WIDTH( 32 ),
    .dout_WIDTH( 32 ))
tansig_fmul_32ns_32ns_32_4_max_dsp_U0(
    .clk( ap_clk ),
    .reset( ap_rst ),
    .din0( grp_fu_38_p0 ),
    .din1( grp_fu_38_p1 ),
...
tansig_fptrunc_64ns_32_3 #(
    .ID( 1 ),
    .NUM_STAGE( 3 ),
    .din0_WIDTH( 64 ),
    .dout_WIDTH( 32 ))
tansig_fptrunc_64ns_32_3_U1(
    .clk( ap_clk ),
    .reset( ap_rst ),
    .din0( grp_fu_44_p0 ),
    .ce( grp_fu_44_ce ),
...
tansig_fpext_32ns_64_3 #(
    .ID( 2 ),
    .NUM_STAGE( 3 ),
    .din0_WIDTH( 32 ),
    .dout_WIDTH( 64 ))
tansig_fpext_32ns_64_3_U2(
    .clk( ap_clk ),
    .reset( ap_rst ),
    .din0( grp_fu_48_p0 ),
    .ce( grp_fu_48_ce ),
...
tansig_dadd_64ns_64ns_64_5_full_dsp #(
    .ID( 3 ),
    .NUM_STAGE( 5 ),
    .din0_WIDTH( 64 ),
    .din1_WIDTH( 64 ),
    .dout_WIDTH( 64 ))
tansig_dadd_64ns_64ns_64_5_full_dsp_U3(
    .clk( ap_clk ),
    .reset( ap_rst ),
    .din0( grp_fu_51_p0 ),
    .din1( grp_fu_51_p1 ),
...
tansig_ddiv_64ns_64ns_64_31 #(
    .ID( 4 ),
    .NUM_STAGE( 31 ),
    .din0_WIDTH( 64 ),
    .din1_WIDTH( 64 ),
    .dout_WIDTH( 64 ))
tansig_ddiv_64ns_64ns_64_31_U4(
    .clk( ap_clk ),
    .reset( ap_rst ),
    .din0( grp_fu_57_p0 ),
    .din1( grp_fu_57_p1 ),
...
tansig_dexp_64ns_64ns_64_18_full_dsp #(
    .ID( 5 ),
    .NUM_STAGE( 18 ),
    .din0_WIDTH( 64 ),
    .din1_WIDTH( 64 ),
    .dout_WIDTH( 64 ))
tansig_dexp_64ns_64ns_64_18_full_dsp_U5(
    .clk( ap_clk ),
    .reset( ap_rst ),
    .din0( grp_fu_62_p0 ),
    .din1( grp_fu_62_p1 ),
...
always @(posedge ap_clk)
begin
    if (((ap_ST_st30_fsm_29 == ap_CS_fsm) | (ap_ST_st66_fsm_65 == ap_CS_fsm))) begin
        reg_67 <= grp_fu_51_p2;
    end
end
...
always @ (ap_CS_fsm)
begin
    if ((ap_ST_st69_fsm_68 == ap_CS_fsm)) begin
...
always @ (ap_CS_fsm or tmp_2_reg_88 or tmp_4_reg_93)
begin
...
assign grp_fu_38_ce = ap_const_logic_1;
assign grp_fu_38_p0 = data;
assign grp_fu_38_p1 = ap_const_lv32_C0000000;
assign grp_fu_44_ce = ap_const_logic_1;
assign grp_fu_44_p0 = reg_67;
assign grp_fu_48_ce = ap_const_logic_1;
assign grp_fu_48_p0 = tmp_reg_78;
assign grp_fu_51_ce = ap_const_logic_1;
assign grp_fu_57_ce = ap_const_logic_1;
assign grp_fu_57_p0 = ap_const_lv64_4000000000000000;
assign grp_fu_57_p1 = reg_67;
assign grp_fu_62_ce = ap_const_logic_1;
assign grp_fu_62_p0 = ap_const_lv64_0;
assign grp_fu_62_p1 = tmp_1_reg_83;
assign result = grp_fu_44_p1;
