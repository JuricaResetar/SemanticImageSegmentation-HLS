...
create_ip -name floating_point -version 7.0 -vendor xilinx.com -library ip -module_name tansig_ap_fptrunc_1_no_dsp
# BEGIN Vivado Commands 
...
set_property -dict [list CONFIG.a_precision_type Double \
                          ...
                          CONFIG.component_name tansig_ap_fptrunc_1_no_dsp \
                          ...
                          CONFIG.result_tlast_behv Null] -objects [get_ips tansig_ap_fptrunc_1_no_dsp] -quiet
# END Vivado Parameters
generate_target {synthesis simulation} [get_files tansig_ap_fptrunc_1_no_dsp.xci]
