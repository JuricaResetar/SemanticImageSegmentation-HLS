...
set ::env(PATH) "$::env(PATH);D:/Xilinx/Vivado_HLS/2014.1/win64/tools/fpo_v7_0"
set ::env(PATH) "$::env(PATH);D:/Xilinx/Vivado_HLS/2014.1/win64/tools/opencv"
set ::env(PATH) "$::env(PATH);D:/Xilinx/Vivado_HLS/2014.1/win64/tools/fft_v9_0"
set ::env(PATH) "$::env(PATH);D:/Xilinx/Vivado_HLS/2014.1/win64/tools/fir_v7_0"
### C sim ###
